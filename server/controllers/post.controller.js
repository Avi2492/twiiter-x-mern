...
export const getAllPosts = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server error in GetAllPosts controller" });
  }
};
...
export const getLikedPosts = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server error in GetLikedPosts controller" });
  }
};
...
export const getFollowingPosts = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server error in GetFollowingPosts controller" });
  }
};
...
export const getUserPosts = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Internal Server error in GetUserPosts controller" });
  }
};
